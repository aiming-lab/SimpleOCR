...
class ImageTextOverlay:
    ...
    def __init__(self, seed: Optional[int] = None, enable_random: bool = True):
        ...
        # Fixed settings (used when enable_random=False)
        self.fixed_font_size = 24
        self.fixed_color = (0, 0, 0)  # black
    ...
    def add_text_to_image(self, image: ImageObject, text: str) -> ImageObject:
        ...
        Returns:
            New PIL Image object with text overlay appended at the bottom
        """
        try:
            ...
            while font_size >= 12:
                ...
                # Check if all lines fit within the image width
                all_lines_fit = True
            ...
            # Draw text below the original image
...
# Global instance for easy access (non-seeded, random behavior)
_overlay_instance = None


def add_text_to_image(image: ImageObject, text: str, seed: Optional[int] = None) -> ImageObject:
    """
    Convenience function to add a text overlay to an image.
    ...
    Args:
        ...
        seed: Random seed for reproducibility (optional).
              ...
              If None, uses the global instance with random behavior.
